...
public class EmailComposer extends CordovaPlugin {
	...
	private void sendEmail(JSONObject parameters) {
		...
		try {
			...
			LOG.e("EmailComposer", "BB Error handling isHTML param: " + e.toString());
		}
		...
		try {
			...
			LOG.e("EmailComposer", "FF Error handling subject param: " + e.toString());
		}
		...
		try {
			...
			LOG.e("EmailComposer", "GG Error handling body param: " + e.toString());
		}
		...
		try {
			...
			LOG.e("EmailComposer", "HH Error handling toRecipients param: " + e.toString());
		}
		...
		try {
			...
			LOG.e("EmailComposer", "II Error handling ccRecipients param: " + e.toString());
		}
		...
		try {
			...
			LOG.e("EmailComposer", "HH Error handling bccRecipients param: " + e.toString());
		}
		...
		try {
			...
			LOG.e("EmailComposer", "FBM: " + attachments.toString());
			
			if (attachments != null && attachments.length() > 0) {
				ArrayList<Uri> uris = new ArrayList<Uri>();
				//convert from paths to Android friendly Parcelable Uri's
				LOG.e("EmailComposer", "FBM2: " + attachments.toString());
				for (int i=0; i<attachments.length(); i++) {
					try {
						/* file:\/\/\/mnt\/sdcard\/score.html*/
						String as = new String ("\\/");
						String das = new String("/");
						String str =attachments.getString(i).replace(as, das);
						as = new String ("file://");
						das = new String("");
						str=str.replace(as, das);
						File file = new File(str);
						
						LOG.e("EmailComposer", "FBM4: " + str);
						
						if (file.exists()) {
							Uri uri = Uri.fromFile(file);
							
							LOG.e("EmailComposer", "FBM3: " + str);
							
							
							uris.add(uri);
						}
					} catch (Exception e) {
						LOG.e("EmailComposer", "UU Error adding an attachment: " + e.toString());
					}
				}
				if (uris.size() > 0) {
			...
			LOG.e("EmailComposer", "ZZZ Error handling attachments param: " + e.toString());
		}
